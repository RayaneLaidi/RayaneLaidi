...
## 🔥 About Me
- 🎓 Student in web developement at @ IIM Digital School (France)  
- 💻 Passionate about software development, fintech, cloud computing, artificial intelligence  , Machine Learning 
- 🌱 Building my skills to become a top-tier DevOps/Cloud engineer
- 🎯 Goal: create meaningful tech projects and contribute to their development
...
<script>
  ...
  let colors = ['#FF3C3C','#FF8C00','#FFD700','#3CB371','#1E90FF','#8A2BE2'];
  let i = 0;
  setInterval(() => {
...
<!--
**RayaneLaidi/RayaneLaidi** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
